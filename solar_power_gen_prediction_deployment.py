...
day_of_year = st.number_input("Day of Year",min_value=1,max_value=366,step=1)
year = st.selectbox("Year", [2008, 2009])
month = st.number_input("Month",min_value=1,max_value=12,step=1)
day = st.number_input("Day",min_value=1,max_value=31,step=1)
first_hour_of_period = st.number_input("First Hour of Period",min_value=1,step=1)
